...
class Page extends Model
{
    ...
    public function scopeWithJoins($query)
    {
        ...
        return $query
            ...
            ->leftJoin('meta_keyword', 'meta_keyword.meta_id', 'metas.id')
            ->leftJoin('keywords', 'meta_keyword.keyword_id', 'keywords.id');
    }
    ...
    public function scopeWithSelection($query)
    {
        return $query->select([
            ...
            DB::raw('GROUP_CONCAT(keywords.keyword) as meta_keywords')
        ]);
    }
}
