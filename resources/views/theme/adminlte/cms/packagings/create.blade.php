<form action="{{ route('admin.cms.packagings.store') }}" method="post" class="ajax-form" enctype="multipart/form-data"
  onsubmit="handleFormSubmission(this)">
  @csrf
  <div class="p-3 border-bottom flex-shrink-0" style="background:#f8f9fa;">
    <div class="d-flex flex-row justify-content-between align-items-center">
      <h4 id="aside-heading" class="mb-0">@lang('crud.create_title', ['name' => 'Packaging'])</h4>
  ...
  <div class="flex-fill" style="overflow-y:auto; min-height:0; max-height:calc(100vh - 132px);">
    <div class="p-3" id="aside-inner-content">
      ...
      <div class="row">
        <div class="col-md-12">
          @include('theme.adminlte.components._packaging-form', [
              'packaging' => $packaging,
          ])
        </div>
      </div>
