<form action="{{ route('admin.cms.packagings.update', $packaging) }}" method="post" class="ajax-form"
  ...
  <div class="p-3 border-bottom flex-shrink-0" style="background:#f8f9fa;">
    <div class="d-flex flex-row justify-content-between align-items-center">
      <h4 id="aside-heading" class="mb-0">@lang('crud.edit_title', ['name' => 'Packaging'])</h4>
